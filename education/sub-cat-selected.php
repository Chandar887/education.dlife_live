    ...
    <div class="col-12 bg-primary text-white p-2">
        <div class="container">
            <div class="row d-flex justify-content-around">
                <a href="index.php" class="ml-2 text-white loading" style="font-size: 6vw;"><b><?php echo $categoryData[0]['parent_category']; ?></b><span class="ml-1"><i class="fa fa-edit"></i></span></a>
                <a href="sub-category.php?parent_category=<?php echo $categoryData[0]['parent_category']; ?>" class="ml-2 text-white loading" style="font-size: 6vw;"><b><?php echo $sub_category; ?></b><span class="ml-1"><i class="fa fa-edit"></i></span></a>
            </div>
        </div>
    </div>
</section>

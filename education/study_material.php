...
//   *************** check type of study material
    ...
    if (isset($_GET['parent'])) {
        ...
        if($parent == '6th To 12th'){
             $studyMaterialData = $db->selectQuery("select * from study_material where sub_category = '$sub_category' and study_type = '$type' and subject = '$subject_name' and parent_category = '$parent'");
        } else {
             $studyMaterialData = $db->selectQuery("select * from study_material where sub_category = '$sub_category' and study_type = '$type' and parent_category = '$parent'");
        }
       
//    } else {
//        $studyMaterialData = $db->selectQuery("select * from study_material where sub_category = '$sub_category' and study_type = '$type' and subject = '$subject_name'");
    }
}

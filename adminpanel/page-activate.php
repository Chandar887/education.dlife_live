...
$request["coin"]=isset($request["coin"]) ? number_format($request["coin"]) : $settings['value'];
?>
    ...
    <div class="col-12 col-md-8 mx-auto">
        <form class="border rounded p-4 submitform" action="controller/controller.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group mb-4">
                ...
                <input type="number" id="coins" name="uCoin" min="1" step="1" class="form-control U_coin" data-id='<?php echo $uData['uMobile'] ?>' placeholder="Coin Amount *" value="<?php echo number_format($request["coin"]); ?>" readonly required>
            </div>
            <div class="form-group mb-4">
            ...
            <div class="form-group">
                <button type="submit" name="submit" value="activateUser" class="btn btn-primary btn-block button_submit">Activate</button>
            </div>
        </form>
    </div>
</main>
